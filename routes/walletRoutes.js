...
router.get("/recent-transaction-users/:userId", walletController.recentTransactionUsers);
...
// Protected routes
router.post("/fund/initialize", authenticateToken, walletController.initializeWalletFunding);
